...
const ReservationCheckLabel: React.FC<ReservationCheckLabelProps> = ({isActive, labelText}) => {
  return (
...
const Label = styled.div<{$isActive: boolean}>`
  ...
  background-color: ${({$isActive}) =>
    $isActive ? ' var(--Podo-Ticket-chip-light-purple02, #F5F4FF);' : 'var(--ect-white, #FFF);'};
  border: 1px solid
